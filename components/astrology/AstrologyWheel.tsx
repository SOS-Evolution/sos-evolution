                    ...
                    return (
                        ...
                        >
                            ...
                            <g className="cursor-help transition-transform hover:scale-110">
                                ...
                                <title>
                                    {t.rich(`planets.${planet.name}`, { fallback: () => planet.name }) as unknown} {t('in_sign')} {planet.sign !== "---" ? tz.rich(planet.sign, { fallback: () => planet.sign }) as unknown : "---"} ({planet.normDegree.toFixed(1)}°)
                                </title>
                            </g>
                        </motion.g>
                    );
