...
export function TarotCard({ cardName, imageUrl, isRevealed, onClick, frameId }: TarotCardProps) {
    ...
    return (
        <div className="relative w-64 h-96 perspective-1000 cursor-pointer group" onClick={onClick}>
            <motion.div
